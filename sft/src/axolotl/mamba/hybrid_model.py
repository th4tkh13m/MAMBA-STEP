...
from axolotl.mamba.hybrid_mamba_layer import Mamba
...
class MHADecoderLayer(nn.Module):
    ...
    def forward(self, hidden_states: Tensor, inference_params=None, *args, **kwargs):
        ...
        hidden_states = self.mha(hidden_states, inference_params=None)
...
class MambaDecoderLayer(nn.Module):
    ...
    def forward(self, hidden_states: Tensor, inference_params=None, *args, **kwargs):
        residual = hidden_states
        hidden_states = self.input_layernorm(hidden_states)
        hidden_states = self.mamba(hidden_states, inference_params=None)
        hidden_states = residual + hidden_states
