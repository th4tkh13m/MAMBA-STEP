...
def main(config):
    ...
    # Save metrics to CSV
    csv_path = os.path.join(output_dir, f'pass_t{config.rollout.temperature}_n{config.data.n_samples}_topp_{config.rollout.top_p}_l{config.rollout.response_length}.csv')
